...
public class CrossingManagerMakeCrossesComponent extends VerticalLayout 
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        gridLayoutSelectingParentOptions.setMargin(new MarginInfo(true, false, false, false));
        ...
        crossesTableComponent.setMargin(new MarginInfo(true, false, false, false));
        ...
        if (!femaleList.isEmpty() && !maleList.isEmpty()){
            ...
            // Top to Bottom Crossing    
                ...
                if (femaleList.size() == maleList.size()){
                    ...
                    MessageNotifier.showError("Error with selecting parents."
    ...
    public void selectFemaleParentList() {
        ...
        UI.getCurrent().addWindow(selectListWindow);
    }
    ...
    public void setupDefaultListFromFile(){
        ...
        if(crossingManagerUploader.isFemaleListIdSpecified() && crossingManagerUploader.isMaleListIdSpecified() &&
            ...
            MessageNotifier.showWarning("Warning!", messageSource.getMessage(Message.ERROR_GERMPLASM_LIST_IMPORT_BOTH_ID_REQUIRED)
                    , Position.MIDDLE_CENTER);
            ...
            MessageNotifier.showWarning("Warning!", messageSource.getMessage(Message.ERROR_GERMPLASM_LIST_IMPORT_FEMALE_ID_REQUIRED)
                    , Position.MIDDLE_CENTER);
            ...
            MessageNotifier.showWarning("Warning!", messageSource.getMessage(Message.ERROR_GERMPLASM_LIST_IMPORT_MALE_ID_REQUIRED)
                    , Position.MIDDLE_CENTER);
