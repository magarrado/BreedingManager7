...
public class SaveGermplasmListComponent extends AbsoluteLayout implements InitializingBean, InternationalizableComponent{
    ...
    public void nextButtonClickAction() throws InternationalizableException {
        ...
        if (validateRequiredFields()){
                    ...
                    ConfirmDialog.show(UI.getCurrent(), messageSource.getMessage(Message.SAVE_GERMPLASM_LIST),
    ...
    private boolean validateRequiredFields(){
          ...
          return
          GermplasmImportUtil.validateRequiredStringField(listNameText,
                  messageSource, (String) listNameLabel.getCaption())

          && GermplasmImportUtil.validateRequiredStringField(descriptionText,
              messageSource,     (String) descriptionLabel.getCaption())

          && GermplasmImportUtil.validateRequiredField(listTypeComboBox,
              messageSource, (String) listTypeLabel.getCaption())

          && GermplasmImportUtil.validateRequiredField(listDateField,
        ...
        try {
            ...
            Long dataLongValue = Long.parseLong(sDate.replace("-", ""));
             ...
             MessageNotifier.showMessage(messageSource.getMessage(Message.SUCCESS),
                    messageSource.getMessage(Message.GERMPLASM_LIST_SAVED_SUCCESSFULLY), 3000, Position.MIDDLE_CENTER);
