...
public class NurseryTemplateConditionsComponent extends VerticalLayout implements InitializingBean, InternationalizableComponent{
    ...
    siteId.addListener(new Property.ValueChangeListener() {
        ...
        if(loc!=null && noError){
            ...
            if(comboBoxSiteName.getValue()!=null || loc==null){
                MessageNotifier.showWarning("Warning!", messageSource.getMessage(Message.INVALID_SITE_ID), Position.MIDDLE_CENTER);
            }
    ...
    breederId.addListener(new Property.ValueChangeListener() {
        ...
        if(u!=null && noError){
            ...
            if(comboBoxBreedersName.getValue()!=null || u==null){
                MessageNotifier.showWarning("Warning!", messageSource.getMessage(Message.INVALID_BREEDER_ID), Position.MIDDLE_CENTER);
            }
            comboBoxBreedersName.setValue(comboBoxBreedersName.getNullSelectionItemId());
            breederId.setValue("");
        }
    ...
    methodId.addListener(new Property.ValueChangeListener() {
        ...
        if(m!=null && noError){
            ...
            if(comboBoxBreedingMethod.getValue()!=null || m==null){
                MessageNotifier.showWarning("Warning!", messageSource.getMessage(Message.INVALID_METHOD_ID), Position.MIDDLE_CENTER);
            }
    ...
    ConfirmDialog.show(UI.getCurrent(), confirmDialogCaption ,confirmDialogMessage ,
    ...
    try {
        ...
        MessageNotifier.showError(e.getMessage(), "", Position.MIDDLE_CENTER);
    }
